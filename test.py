...
element_report = {
    "목": {
        "성격": "끊임없는 성장과 도전을 추구하는 타입. 웹툰 속에서는 늘 새로운 세계를 개척하는 인물입니다.",
    ...
    "화": {
        "성격": "열정과 추진력이 강한 타입. 카리스마가 넘치며 감정에 솔직합니다.",
    ...
    "토": {
        "성격": "안정적이고 든든한 타입. 성실하고 믿음을 주는 성격입니다.",
    ...
    "금": {
        "성격": "냉철하고 결단력 있는 타입. 카리스마와 강한 의지를 가졌습니다.",
    ...
    "수": {
        "성격": "지혜롭고 신비로운 타입. 직관력이 뛰어나며 상황에 유연합니다.",
