...
if submitted:
    ...
    element_report = {
        "목":{"성격":"끊임없는 성장과 도전을 추구하며, 새로운 지식과 경험을 탐구하는 모험가형 성격입니다. 친구나 동료를 격려하고 영감을 주지만, 때로는 지나치게 완벽을 추구해 스스로 부담을 느낄 수 있습니다.",
              "연애":"자유롭고 열정적인 연애를 즐기며, 상대에게 새로운 경험과 활력을 제공합니다. 그러나 독립성을 중시하기 때문에 구속을 싫어할 수 있습니다.",
              "재물":"계획적 투자와 꾸준한 노력이 재물운으로 이어지며, 새로운 사업 기회를 활용할 수 있는 능력이 뛰어납니다.",
              "현재":"지금은 새로운 도전과 기회가 다가오는 시기로, 자신의 능력을 시험하고 성장할 수 있는 중요한 시기입니다.",
              "미래":"장기적인 관점에서 큰 성취를 이루며, 지도자적 위치에 서거나 새로운 분야를 개척할 가능성이 높습니다.",
        ...
        "화":{"성격":"열정과 추진력이 강하며, 자신의 감정과 의견을 솔직하게 표현하는 타입입니다. 다소 충동적일 수 있지만, 상황에 따라 카리스마와 리더십을 발휘합니다.",
              "연애":"강렬하고 불꽃 같은 연애를 하며, 상대방에게 깊은 인상을 남깁니다. 때로는 다툼이 생길 수 있으나 금방 화해하는 성향이 있습니다.",
              "재물":"도전적인 투자나 창의적인 사업 아이디어로 재물운이 상승하며, 새로운 기회를 잘 포착합니다.",
        ...
        "토":{"성격":"안정적이고 신뢰감을 주며, 주변 사람들에게 든든한 버팀목이 되는 타입입니다. 차분하고 책임감이 강하며, 꾸준히 목표를 향해 나아갑니다.",
              ...
              "재물":"꾸준한 노력과 성실함이 재물운으로 이어지며, 장기적인 안정성을 중시합니다.",
              "현재":"지금은 성실함이 인정받고 있으며, 안정적인 흐름 속에서 능력을 발휘할 수 있는 시기입니다.",
