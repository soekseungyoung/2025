...
# -------------------- 랜덤 색상 --------------------
colors = ["#FF0000", "#FF7F00", "#FFFF00", "#00FF00", "#0000FF", "#4B0082", "#8B00FF"]  # 빨, 주, 노, 초, 파, 남, 보
border_color = random.choice(colors)
shadow_color = random.choice(colors)
flame_colors = random.sample(colors, 3)  # 불꽃 애니메이션용
...
@keyframes flame {{
    0% {{ box-shadow: 0 0 30px {flame_colors[0]}, 0 0 60px {flame_colors[1]}, 0 0 90px {flame_colors[2]}; }}
    50% {{ box-shadow: 0 0 50px {flame_colors[1]}, 0 0 80px {flame_colors[2]}, 0 0 120px {flame_colors[0]}; }}
    100% {{ box-shadow: 0 0 30px {flame_colors[2]}, 0 0 60px {flame_colors[0]}, 0 0 90px {flame_colors[1]}; }}
}}
</style>
